...
//             let receiver = transfer::make_receiver<KioskOwnerCap>(nft_id, 1);

//            // let (cap, promise) = receive::receive_kiosk_owner_cap(&mut nft, Receiving<KioskOwnerCap>{id: nft_id, version: 1});
