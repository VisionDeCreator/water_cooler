module galliun::receive {
    ...
    /// to the MizuNFT before completing a PTB.
    ...
    /// A catch-all function to receive objects that have been sent to the MizuNFT.
    ...
    /// A function for receiving USDC coin objects that have been sent to the MizuNFT.
    ...
    /// A function for receiving the MizuNFT's KioskOwnerCap.
    /// This function returns the KioskOwnerCap as well as a ReturnKioskOwnerCapPromise
    /// to return it back to the MizuNFT. In order for a PTB to execute successfully,
    ...
    public fun receive_kiosk_owner_cap(
        ...
        // Assert the KioskOwnerCap to receive matches the KioskOwnerCap assigned to the MizuNFT.
    ...
    /// Return the KioskOwnerCap back to the MizuNFT, and destroy the ReturnKioskOwnerCapPromise.
